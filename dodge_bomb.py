...
def check_bound(obj_rct: pg.Rect):
    ...
    戻り値 : タプル (横方向判断結果, 縦方向判定結果)
    画面内ならTrue, 画面外ならFalse
    """
    yoko, tate = True, True
    if obj_rct.left < 0 or WIDTH < obj_rct.right:  # 練習４ : 横方向判定
        yoko = False
    if obj_rct.top < 0 or HEIGHT < obj_rct.bottom:  #練習４ : 縦方向判定
        tate = False
    return yoko, tate
...
def main():
    ...
    bg_img.set_colorkey((0, 0, 0))  # 練習１ : 黒い部分を透明にする
